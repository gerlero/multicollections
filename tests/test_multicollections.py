...
def test_repr() -> None:
    ...
    original: MultiDict[str, str | int] = MultiDict([("x", "hello"), ("y", 42), ("x", "world")])
...
@pytest.mark.parametrize("cls", [MultiDict, ListMultiDict, multidict.MultiDict])
def test_setdefault_method(cls: type[MutableMultiMapping[str, int]]) -> None:
...
@pytest.mark.parametrize("cls", [MultiDict, ListMultiDict, multidict.MultiDict])
def test_edge_cases_none_values(cls: type[MutableMultiMapping[str, str | None]]) -> None:
...
@pytest.mark.parametrize("cls", [MultiDict, ListMultiDict, multidict.MultiDict])
def test_edge_cases_single_item_operations(cls: type[MutableMultiMapping[str, str]]) -> None:
...
@pytest.mark.parametrize("cls", [MultiDict, ListMultiDict, multidict.MultiDict])
def test_edge_cases_duplicate_handling(cls: type[MutableMultiMapping[str, int]]) -> None:
...
def test_edge_cases_mixed_types(cls: type[MutableMultiMapping[str | int | tuple[str, str] | None, str | int | list[int] | dict[str, str]]]) -> None:
